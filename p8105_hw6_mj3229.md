...
seems to centered around 0.942 and has a tight fit. This may indicate
...
|----------------:|----------------:|----------------:|
|         279.752 |         330.709 |         288.385 |

Comparing the three models, model 1 shoes the lowest RMSE, indicating
...
highest RMSE. Becuase it is a simpler model, might be the least accurate
...
accuracy. From this, overal model 1 has the best balance of accuracy
